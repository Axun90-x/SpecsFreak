...
## 📂 Project Structure
<pre> Hybrid-Game-Recommender/ │ ├── colab_notebooks/ │ ├── Game_Recommender.ipynb │ ├── Sentiment_Analysis.ipynb │ └── EDA.ipynb │ ├── backend/ │ ├── app.py │ ├── recommender.py │ ├── sentiment.py │ └── model/ │ ├── tfidf.pkl │ └── similarity.pkl │ ├── dataset/ │ └── games.csv │ ├── frontend/ │ ├── index.html │ ├── style.css │ └── script.js │ ├── outputs/ │ └── sample_results.png │ ├── requirements.txt ├── README.md └── .gitignore </pre>
